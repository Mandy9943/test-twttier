...
const ClawMachine = () => {
  ...
  useEffect(() => {
    ...
    $(document).ready(function () {
      $(ref.current).on("click", "#b_drop", function () {
        ...
        >
          <defs>
            <linearGradient
              ...
              y2="320943"
            >
              <stop offset="0" stopOpacity="1" stopColor="#5B5B5B" />
              <stop offset="1" stopOpacity="1" stopColor="#403F3F" />
            </linearGradient>
            <linearGradient
              id="id1"
              gradientUnits="userSpaceOnUse"
              ...
              y2="4.26414e+06"
            >
              <stop offset="0" stopOpacity="1" stopColor="#4A4A4A" />
              <stop offset="1" stopOpacity="1" stopColor="#1F1B20" />
            </linearGradient>
          </defs>
          <path
            fill="url(#id0)"
